...
public class Calculator {
    ...
    public void setOperationPerformed(final int val) {
        this.operationsPerformed = val;
    }

    public void setLastResult(final double val) {
        this.lastResult = val;
    }
    ...
    */
    ...
    public String toString() {
        return "[Calculator operation: " + getOperationPerformed() + 
