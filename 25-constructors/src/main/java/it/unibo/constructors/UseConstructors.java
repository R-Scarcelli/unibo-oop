...
class UseConstructors {
    ...
    public static void main(final String[] args) {
        ...
        // seconda classe
        Train secondTrain = new Train(50, 1050);
        secondTrain.printTrainInfo();
        System.out.println("secondTrain Total seat correct? " + (secondTrain.getTotalSeats() == secondTrain.getFirstClassSeats() + secondTrain.getSecondClassSeats()) + "]\n");
        
        // 7) Creare un treno con 500 posti, tutti di seconda classe
        Train thirdTrain = new Train(0, 500);
        thirdTrain.printTrainInfo();
        System.out.println("thirdTrain Total seat correct? " + (thirdTrain.getTotalSeats() == thirdTrain.getFirstClassSeats() + thirdTrain.getSecondClassSeats()) + "]\n");
       
        // 8) Creare un treno con numero di posti di default
        Train fourthTrain = new Train();
        fourthTrain.printTrainInfo();
        System.out.println("fourthTrain Total seat correct? " + (fourthTrain.getTotalSeats() == fourthTrain.getFirstClassSeats() + fourthTrain.getSecondClassSeats()) + "]\n");
